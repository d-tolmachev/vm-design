...
@NodeInfo(shortName = ">=")
public final class LamaGreaterOrEqualNode extends LamaExpressionNode {
    @Child private LamaExpressionNode leftNode;
    @Child private LamaExpressionNode rightNode;

    public LamaGreaterOrEqualNode(LamaExpressionNode leftNode, LamaExpressionNode rightNode) {
